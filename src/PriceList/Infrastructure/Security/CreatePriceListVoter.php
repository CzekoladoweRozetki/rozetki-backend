...
/**
 * @extends Voter<string, CreatePriceListCommand>
 */
class CreatePriceListVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        if (CreatePriceListCommand::class !== $attribute) {
            return false;
        }

        if (!$subject instanceof CreatePriceListCommand) {
            return false;
        }
