...
/**
 * @extends Voter<string, SchedulePriceChangeCommand>
 */
class SchedulePriceChangeVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        if (SchedulePriceChangeCommand::class !== $attribute) {
            return false;
        }

        if (!$subject instanceof SchedulePriceChangeCommand) {
            return false;
        }
