...
/**
 * @extends Voter<string, CancelFuturePriceCommand>
 */
class CancelFuturePriceVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        if (CancelFuturePriceCommand::class !== $attribute) {
            return false;
        }

        if (!$subject instanceof CancelFuturePriceCommand) {
            return false;
        }
