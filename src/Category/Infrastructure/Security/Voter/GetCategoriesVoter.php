...
/**
 * @extends Voter<string, GetCategoriesQuery>
 */
class GetCategoriesVoter extends Voter
{
    protected function supports(string $attribute, mixed $subject): bool
    {
        if (GetCategoriesQuery::class !== $attribute) {
            return false;
        }

        if (!$subject instanceof GetCategoriesQuery) {
            return false;
        }
